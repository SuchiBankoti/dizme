...
const Portfolio = () => {
  ...
  useEffect(() => {
    if (portfolioRef.current) {
      dataImage(portfolioRef.current);
    }
  }, [projects]);
  // Isotope
  ...
  return (
    <div className="dizme_tm_section" id="portfolio" ref={portfolioRef}>
      <DetailsPopup
        open={popup}
                ...
                projects.map((item, index) => {
                  return (
                    <li
                      ...
                      onClick={() => {
                        if (item.className == "detail grid-item") {
                          setPopup(index);
                        }
                      }}
                    >
                      <div className="inner">
                        ...
                        >
                          ...
                          >
                            ...
                            <div className="main" data-img-url={item.imgUrl} />
                          </a>
                        </div>
